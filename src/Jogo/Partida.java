	...
	public void inicioPartida(List <Jogador> salvaJogadores, List <Pergunta> perguntas) {
		...
		int i = 0;
			...
			if(salvaJogadores.size() == 1) {
				if(salvaJogadores.get(0).getJogador1P().getTempoDeVida() <= 0) {
					...
					System.exit(0);
					//enquanto a vida do personagem do jogador 1 for maior do que 0 ele joga avontade
					while(salvaJogadores.get(0).getJogador1P().getTempoDeVida() > 0) {
						...
						if(respostaJogador1 == perguntas.get(i).getAlternativaCorreta()) {					
							...
							salvaJogadores.get(0).getJogador1P().setTempoDeVida(salvaJogadores.get(0).getJogador1P().getTempoDeVida()-30);
